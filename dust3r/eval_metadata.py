...
dataset_metadata = {
    'mvsec': {
        ...
        'seq_img_path': "data/MVSEC/monst3r_test_rect_odem/l40",
        'mask_path': None,
        # 'dir_path_func': lambda img_path, seq: os.path.join(img_path, seq, "image_left"),
        'dir_path_func': lambda seq_img_path, seq: os.path.join(seq_img_path, seq, "seq63/image_left_interpolated"),
        'event_path_func': lambda seq_img_path, seq: os.path.join(seq_img_path, seq, "seq63/event_left/event_voxel_left"),
        'event_stream_all_path': lambda all_img_path, seq: os.path.join(all_img_path, seq, "event_left/all_event.hdf5"),
        # 'dir_path_func': lambda seq_img_path, seq: os.path.join(seq_img_path, seq, "seq0/image_evlight_left"),
        # 'gt_traj_func': lambda seq_img_path, anno_path, seq: os.path.join(seq_img_path, seq, "odem_pose_left.txt"),
        'gt_traj_func': lambda seq_img_path, anno_path, seq: os.path.join(seq_img_path, seq, "seq63/odem_pose_left.txt"),
        'traj_format': 'mvsec',
