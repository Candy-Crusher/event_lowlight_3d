...
dataset_metadata = {
    'mvsec': {
        ...
        'gt_traj_func': lambda img_path, anno_path, seq: os.path.join(img_path, seq, "seq63/odem_pose_left.txt"),
        'traj_format': 'mvsec',
...
def process_mvsec(args, img_path):
    ...
    for seq in tqdm(seq_list):
        ...
        if args.use_event_control:
            event_filelist = sorted(glob.glob(f'{img_path}/{seq}/event_left/event50_voxel_left/*.hdf5'))
        else:
            event_filelist = None
