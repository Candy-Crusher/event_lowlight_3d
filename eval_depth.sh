...
experiment_name="MonST3R_PO-TA-S-W_ViTLarge_BaseDecoder_512_dpt_mvsec_rect_wE_SNRmultiatt_eventbranch_v3"
    # --pretrained="checkpoints/MonST3R_PO-TA-S-W_ViTLarge_BaseDecoder_512_dpt.pth"   \
CUDA_VISIBLE_DEVICES=1 torchrun --nproc_per_node=1 --master_port=29605 launch.py --mode=eval_depth  \
