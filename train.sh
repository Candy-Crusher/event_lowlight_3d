CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node=8 --master_port=29604 launch.py  --mode=train \
    ...
    --output_dir="/mnt/sdc/xswu/3d/code/results/MonST3R_PO-TA-S-W_ViTLarge_BaseDecoder_512_dpt_mvsec_rect_wE_SNRmultiatt_eventbranch" \
    --wandb \
    --use_event_control \
