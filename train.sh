CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node=4 --master_port=29605 launch.py  --mode=train \
    ...
    --output_dir="/mnt/sdc/xswu/3d/code/results/ours_finetune_wE_cat" \
    --wandb \
    --use_event_control \
