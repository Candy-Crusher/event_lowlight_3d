...
CUDA_VISIBLE_DEVICES=4 torchrun --nproc_per_node=1 --master_port=29612 launch.py --mode=eval_pose  \
    --pretrained="checkpoints/MonST3R_PO-TA-S-W_ViTLarge_BaseDecoder_512_dpt.pth"   \
    --eval_dataset=mvsec --output_dir="/mnt/sdc/xswu/3d/code/results/${experiment_name}_only_levent" \
